...
public class SmoothImageView extends ImageView {
	...
	private static final int STATE_NORMAL1 = 0;
	private static final int STATE_NORMAL2 = -1;
	...
	private int mState = STATE_NORMAL1;
...
//		setBackgroundColor(mBgColor);
	...
	public void changeOriginalInfo(int width, int height, int locationX, int locationY) {
		mOriginalWidth = width;
		mOriginalHeight = height;
		mOriginalLocationX = locationX;
		mOriginalLocationY = locationY;
